...
public class HtmlAddonResource extends Resource {
  ...
  private static final String TAG_BODY_OPENING = "<body"; // ignore bracket here to support
                                                          // potential html attributes
  ...
  public HtmlAddonResource(final Resource indexResource, final String bodyAddon,
      final String headAddon) {
    LOGGER.info("Enabling html addons in " + indexResource + ": body='{}' head='{}'", bodyAddon,
        headAddon);
    ...
    try {
      ...
      // only relevant in development mode: create altered temp file (as zeppelin web archives are
      // addressed via local
      // filesystem folders)
